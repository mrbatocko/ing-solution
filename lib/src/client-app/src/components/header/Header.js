...
class Header extends React.Component {
  ...
  render () {
    ...
    return (
      <nav className="pt-1 pb-1 bg-grey-light border-bottom border-grey">
        <div className="container flex items-center">
          ...
          <ul className={[ classes.linksList, 'flex', 'm-0', 'pl-0', 'flex-1' ].join(' ')}>
            <li className="mr-2">
              <NavLink exact to="/" activeClassName="blue" className="no-decoration">Posts</NavLink>
            </li>
            <li>
              <NavLink to="/sections" activeClassName="blue" className="no-decoration">Sections</NavLink>
            </li>
          </ul>
          {!authenticated ? (
            <div>
            ...
            <button
              className="pl-0 pr-0 cursor-pointer border-none bg-transparent"
