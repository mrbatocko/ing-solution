...
import classes from './PostForm.css';
...
class PostForm extends React.Component {
  ...
  render () {
    ...
    return (
      <div className={classes.postFormComponent}>
        <button
          className={[ 'mb-3 border border-width-2 text-bold border-green-dark green-dark pl-2 pb-1 pr-2 flex items-center', classes.postFormActivator ].join(' ')}
                    ...
                    <div>
                      ...
                      <div className="pt-3 text-right">
                        <button
                          onClick={this.toggleModal}
                          type="button"
                          className="cursor-pointer bg-transparent black border-none">
                          Cancel
                        </button>
                        <button
                          ...
                          type="submit"
                          className="cursor-pointer ml-2 border-rounded bg-green-dark white border-none pt-1 pb-1 pl-2 pr-2">
                          Post
                        </button>
                      </div>
                    </div>
